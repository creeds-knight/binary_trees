...
/**
 * binary_tree_balanc - This measures the balance factor of a binary tree.
 ...
 */
int binary_tree_balance(const bianry_tree_t *tree)
{
	if (tree)
...
size_t binary_tree_height(const binary_tree_t *tree)
{
	if (tree)
	{
		...
		l = tree->left ? 1 + binary_tree_height(tree->leftt) : 1;
